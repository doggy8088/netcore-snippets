...
| ac-connstr-trusted   | Generates a `ConnectionStrings` section with Trusted_Connection  |
| ac-connstr-ip        | Generates a `ConnectionStrings` section with IP_Connection       |
